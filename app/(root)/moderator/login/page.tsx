...
export default function Login() {
    ...
    const logIn = async (data: { password: string; login: string }) => {
    ...
    const onSubmit: SubmitHandler<{ password: string; login: string }> = (
        data
    ) => logIn(data);
    ...
    return (
        ...
        inset-shadow-[0px_0px_20px_2px_rgba(255,255,255,0.25)]  flex-col w-[450px] h-[500px] m-auto "
            >
