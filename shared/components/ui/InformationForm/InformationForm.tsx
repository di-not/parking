    ...
    return (
        <div className="mt-9">
            ...
            >
                ...
                />
                <Select>
                    <SelectTrigger className="flex justify-between font-medium items-center shadow-[0px_3px_4px_0px_rgba(0,0,0,0.25)] p-[11px] pl-5 pr-6 w-full bg-black/30   inset-shadow-[0px_0px_10px_0.1px_rgba(255,255,255,0.1)]
                    rounded-full text-white text-[16px] focus:outline-1! outline-[#fff]/30! outline-offset-0! ">
                        <SelectValue placeholder="Менеджер" />
                    </SelectTrigger>
                    <SelectContent className="bg-[#000]/25 backdrop-blur-3xl rounded-4xl shadow-[1px_0px_1px_0px_rgba(255,255,255,0.25)] inset-shadow-[0px_0px_4px_0.1px_rgba(255,255,255,0.25)] max-h-[250px]">
    ...
    return (
        <div className="">
            <input
                {...register}
                type={type ? type : "text"}
                className="text-white shadow-[0px_3px_4px_0px_rgba(0,0,0,0.25)] inset-shadow-[0px_0px_10px_0.1px_rgba(255,255,255,0.1)] p-2.5 pl-5 pr-14 w-full text-[16px] font-medium bg-black/30 rounded-full placeholder:text-white/50 text-lg focus:outline-1 outline-[#fff]/30 outline-offset-0"
